...
const args = yargs.scriptName('tool-project-helper or tph').argv
...
if (args.name && args.parent) {
  ...
  fs.writeFileSync(join(libDir, 'index.mjs'), `export default {}`)

  fs.writeFileSync(join(newPackageDir, 'index.mjs'), `export * from './lib'`)
